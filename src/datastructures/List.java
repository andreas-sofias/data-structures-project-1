...
public class List<T> implements ListInterface<T> {
	    ...
	    { 
	    	if (this.isEmpty()) 
	    	{
	    		throw new NoSuchElementException("Error stack is not initialized");
	    	}
	    	T data_result = this.head.getData();return data_result;
	    }
	    ...
	    { 
	    	...
	    	T data_result = this.tail.getData();return data_result;
	    }
	    ...
	    public void modifyHead(T data) {
	    	head.setData(data);
	    }
	    public void modifyTail(T data) {
	    	tail.setData(data);
	    }
	    /**
